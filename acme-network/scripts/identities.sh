...
issueCertificatesWithAffiliation int 7056 org1.acme.com client@org1.acme.com clientpw client marketplace "$CSR_NAMES_ORG1" ""
...
# issue certificates for client identity and for client tls
issueCertificatesWithAffiliation int 8056 org2.acme.com client@org2.acme.com clientpw client marketplace "$CSR_NAMES_ORG2" ""
...
# issue certificates for client identity and for client tls
issueCertificatesWithAffiliation int 9056 org3.acme.com client@org3.acme.com clientpw client marketplace "$CSR_NAMES_ORG3" ""
